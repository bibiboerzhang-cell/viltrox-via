...
const SHORTFALL_LABELS: Record<string, string> = {
  ...
  freshness_unknown: "最近内容日期待核验",
  latest_video_unknown: "尚未抓到可核验内容，活跃度未知",
  stale: "最近 45 天未更新",
  latest_video_stale: "最近 45 天未更新",
  latest_video_identity_missing: "最近内容缺少可审计链接或内容 ID",
  latest_video_not_active_video: "最近内容缺少该平台有效活动证据",
  latest_video_in_future: "最近内容时间异常",
