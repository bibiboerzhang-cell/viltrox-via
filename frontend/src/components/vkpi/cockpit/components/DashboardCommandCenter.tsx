  ...
  return e(m.div, {
    ...
    !viewMode && e("div", { className: "absolute inset-0 flex items-center justify-center" },
      e("div", { className: "max-w-md px-6 text-center" },
        ...
        e("div", { className: "flex flex-wrap justify-center gap-2 text-xs text-muted" },
          ...
          e("span", { className: "rounded-md border border-yellow-500/20 bg-yellow-500/[0.04] px-3 py-1.5 text-yellow-400/80" }, e(Loader2, { size: 11, className: "mr-1 inline-block animate-spin" }), "Customer data pending"),
        ),
      ),
    ),
    ...
    viewMode === "customer" && !isAvailable && e("div", { className: "absolute inset-0 flex items-center justify-center" },
      e("div", { className: "mx-4 max-w-lg rounded-2xl border border-yellow-500/30 bg-yellow-500/[0.05] p-8 text-center backdrop-blur-xl" },
        e("div", { className: "mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-yellow-500/20" }, e(Loader2, { size: 24, className: "animate-spin text-yellow-400" })),
    ...
    !showSettingsModal && revenueBySource.length > 0 && e("div", { className: "absolute bottom-6 right-6", style: { zIndex: 800 } },
      e(FloatingCard, {
        ...
        revenueBySource.map((source: any) => e("div", { key: source.label, className: "mb-1.5 flex items-center justify-between text-[11px] last:mb-0" },
          e("span", { className: "flex items-center text-slate-300" }, e("i", { className: "mr-2 inline-block h-1.5 w-1.5 rounded-full", style: { background: source.color } }), source.label),
          e("span", { className: "tabular-nums text-slate-400" }, `${source.pct}%`),
        )),
      ),
    ),
