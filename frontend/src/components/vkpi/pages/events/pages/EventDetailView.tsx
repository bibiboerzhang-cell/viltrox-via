...
import RetroTab from "../tabs/RetroTab";
import TasksTab from "../tabs/TasksTab";
import type {
  CurrentUserVm, EventVm, ExpenseVm, InviteVm, MaterialVm, ProductVm,
  StockItem, TaskVm, UiStaff,
} from "../shared/types";
...
export default function EventDetailView({ ev, onBack, currentUser, onEdit, onDelete, onUpdateTeam, onEventPatched, stock, setStock, staff = [], token }: EventDetailViewProps) {
  ...
  const [detail, setDetail] = useState<EventDetailData>({ tasks: [], expenses: [], invites: [], materials: [], products: [] });
