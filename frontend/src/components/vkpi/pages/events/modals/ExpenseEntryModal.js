...
export default function ExpenseEntryModal({ onClose, onSubmit }) {
    ...
    e("div", { className: "rounded-2xl border border-white/[0.08] bg-[#0b1220] w-full max-w-lg p-5 max-h-[92vh] overflow-y-auto", onClick: ev => ev.stopPropagation() },
      ...
      e("div", { className: "space-y-3" },
        e("div", { className: "grid grid-cols-2 gap-3" },
          e("div", null,
            ...
            e("div", { className: "relative" },
              ...
              e("input", { type: "number", value: amount, onChange: ev => setAmount(ev.target.value), placeholder: "0",
        ...
        e("div", null,
          ...
          e("input", { type: "text", value: description, onChange: ev => setDescription(ev.target.value),
        ...
        e("div", { className: "grid grid-cols-2 gap-3" },
          e("div", null,
            ...
            e("select", { value: paidBy, onChange: ev => setPaidBy(ev.target.value),
          ...
          e("div", null,
            ...
            e("select", { value: paymentMethod, onChange: ev => setPaymentMethod(ev.target.value),
              className: "w-full px-3 py-2 rounded-md bg-white/[0.02] border border-white/[0.06] text-[11px] text-white focus:outline-none focus:border-purple-500/40" },
              [
                ["company_card", "公司卡"],
                ["personal", "个人垫付"],
                ["wire_transfer", "对公转账"],
              ].map(([v, l]) => e("option", { key: v, value: v, style: { background: "#0a0a0d" } }, l))
            )
          )
        ),
        ...
        paymentMethod === "personal" && e("div", null,
          ...
          e("div", { className: "flex gap-1.5" },
            [["pending", "未申请", "#94a3b8"], ["submitted", "已申请", "#fbbf24"], ["paid", "已报销", "#10b981"]].map(([v, l, c]) =>
