      ...
      e("div", { className: "rounded-lg border border-white/[0.06] bg-white/[0.012] p-3" },
        ...
        e("div", { className: "h-40 rounded bg-[#0a0a0d] border border-white/[0.04] flex items-center justify-center relative overflow-hidden" },
          ...
          e("div", { className: "text-center z-10" },
            ...
            ev.location.lat && e("div", { className: "text-[9.5px] text-slate-500 mt-1 font-mono tabular-nums" },
          ...
          e("div", { className: "flex items-center justify-between mb-2" },
            ...
            e("div", { className: "relative" },
              ...
              addingTeam && e("div", { className: "absolute right-0 top-full mt-1.5 w-48 rounded-lg border border-white/[0.08] bg-[#0b1220] shadow-2xl z-20 p-1.5" },
                ...
                TEAM.filter(u => !ev.teamUserIds.includes(u.id)).length === 0
                  ? e("div", { className: "text-[10.5px] text-slate-400 px-2 py-2" }, "所有人都已加入")
                  : TEAM.filter(u => !ev.teamUserIds.includes(u.id)).map(u =>
                      e("button", {
                        key: u.id,
                        onClick: () => { onUpdateTeam([...ev.teamUserIds, u.id]); setAddingTeam(false); },
