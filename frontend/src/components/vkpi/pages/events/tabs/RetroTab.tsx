...
import {
  ...
  type VkpiEventRetro, type VkpiEvent,
...
export default function RetroTab({ ev, token, reload, onEventPatched }: RetroTabProps) {
  const [retro, setRetro] = useState<VkpiEventRetro | null>(null);
  ...
  const [form, setForm] = useState<RetroForm>({ roi: "", leads: "", videos: "", retrospective: "", status: "" });
  const [dirty, setDirty] = useState(false);

  const hydrateForm = useCallback((r: VkpiEventRetro | null, evStatus: string) => {
  ...
  function setField(key: keyof RetroForm, value: string) {
  ...
  return e("div", { className: "p-5 space-y-4" },
    ...
    e("div", { className: "rounded-xl border border-white/[0.06] bg-white/[0.012] p-4 space-y-3" },
      ...
      e("div", null,
        ...
        e("select", {
          value: form.status,
          onChange: (evt: React.ChangeEvent<HTMLSelectElement>) => setField("status", evt.target.value),
      ...
      e("div", { className: "grid grid-cols-3 gap-3" },
        e("div", null,
          ...
          e("input", {
            ...
            onChange: (evt: React.ChangeEvent<HTMLInputElement>) => setField("roi", evt.target.value),
            placeholder: "—",
        ...
        e("div", null,
          ...
          e("input", {
            ...
            onChange: (evt: React.ChangeEvent<HTMLInputElement>) => setField("leads", evt.target.value),
            placeholder: "—",
            className: "w-full px-3 py-2 rounded-md bg-white/[0.02] border border-white/[0.08] text-[11.5px] text-white tabular-nums placeholder-slate-600 focus:outline-none focus:border-emerald-500/40",
          })
        ),
        e("div", null,
          ...
          e("input", {
            ...
            onChange: (evt: React.ChangeEvent<HTMLInputElement>) => setField("videos", evt.target.value),
            placeholder: "—",
            className: "w-full px-3 py-2 rounded-md bg-white/[0.02] border border-white/[0.08] text-[11.5px] text-white tabular-nums placeholder-slate-600 focus:outline-none focus:border-emerald-500/40",
          })
        )
      ...
      e("div", null,
        ...
        e("textarea", {
          ...
          onChange: (evt: React.ChangeEvent<HTMLTextAreaElement>) => setField("retrospective", evt.target.value),
          rows: 5,
