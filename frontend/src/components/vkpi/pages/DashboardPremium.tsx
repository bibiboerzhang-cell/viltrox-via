...
function PremiumKpiCard({ item }: { item: typeof demoKpis[number] }) {
  return (
...
export function DashboardPremium({ userName = 'Jianbo', userRole = 'Marketing Director', testId = 'vkpi-dashboard-premium' }: DashboardPremiumProps) {
      ...
      <div className="app">
        ...
        <main className="main">
          ...
          <section className="kpis">
            {demoKpis.map((item) => <PremiumKpiCard key={item.label} item={item} />)}
          </section>
