...
export function EnvRow({ name, configured, hint }) {
  return e(
    "div",
    {
      className:
...
export function Card(props: { children?: unknown; className?: string }) {
...
export function FieldInput({ label, type, value, placeholder, onChange, hint }) {
  return e(
    "label",
    { className: "block" },
...
export function FieldSelect({ label, value, onChange, children }) {
  return e(
    "label",
    { className: "block" },
    e("div", { className: "text-[11px] text-slate-400 mb-1" }, label),
