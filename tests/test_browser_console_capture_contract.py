...
def test_capture_script_owns_an_ephemeral_extension_disabled_chromium_and_all_channels() -> None:
    ...
    for required in (
        ...
        "document.querySelector('.vkpi-ask-dialog [data-group=\"suggestions\"] [role=\"option\"]')",
        "['jobs', 'recent', 'suggestions']",
        "home_zones_present",
        ...
        "document.querySelector('.vkpi-ask-dialog__answer')",
        "['is-error', 'is-blocked', 'is-unavailable']",
        ...
        "new URL('/api/admin/vkpi/catalog/suggest', location.href)",
        "['sku', 'display_name', 'lens_key']",
        "catalog_suggest_api_error_absent",
        '"/api/admin/vkpi/catalog/suggest"',
        "sameOriginNon2xxCount",
