...
# A local stack hand-rooted at /tmp/vkpi-candidate-browser-runtime.* inherits
# port 54329 and outlived the gate for hours (runtime/data/postgres + 250KB
# postgres.log found on 2026-08-21).  The freeze-side strict-runtime gate now
# stops such postmasters in its ``finally`` and receipts every outcome.
