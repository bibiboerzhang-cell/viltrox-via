...
LINE_SNAPSHOT: dict[str, int] = {
    ...
    "backend/app/services/ai/analyzers/gemini_video.py": 821,
    "backend/app/services/ai/analyzers/gemini_video_youtube.py": 845,
    ...
    "backend/app/workers/apify_jobs_worker.py": 985,
    "backend/app/workers/apify_jobs_worker_gemini.py": 971,
