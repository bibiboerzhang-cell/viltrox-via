...
def main():
    ...
    print(f"  ✓ {pillars.PROMPT_VERSION}")
    
    print("[3] _build_prompt with full post...")
    post = {
        "platform": "youtube",
    ...
    print("[4] _build_prompt handles empty hashtags...")
    post_empty = {
        "platform": "instagram",
        "title": "",
        "description": "Cool",
    ...
    print("[5] _parse_response handles plain JSON...")
    ...
    print("[6] _parse_response handles markdown...")
    text = '```json\n{"primary_pillar": "vlog"}\n```'
    parsed = pillars._parse_response(text)
    ...
    print("[7] _validate_response with valid input...")
    ...
    print("[8] _validate_response invalid primary fallback to 'other'...")
    ...
    print("[9] _validate_response cap secondary at 2...")
    parsed = {
        "primary_pillar": "lens_review",
    ...
    print("[10] _validate_response confidence clamping...")
    parsed = {
        "primary_pillar": "lens_review",
    ...
    print("[11] _validate_response missing fields...")
    ...
    if failures:
        ...
        print("VKPI_PILLARS_OFFLINE_SMOKE_OK")
