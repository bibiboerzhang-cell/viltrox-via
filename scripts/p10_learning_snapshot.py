#!/usr/bin/env python3
"""P10 read-only learning snapshot CLI."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a read-only P10 learning snapshot.")
