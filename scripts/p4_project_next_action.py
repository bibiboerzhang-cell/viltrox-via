...
from app.domains.recommendations.project_next_action import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--persist-run",
        action="store_true",
        help="P4-13: persist this preview into recommendation run/item/evidence tables with status=previewed",
    )
