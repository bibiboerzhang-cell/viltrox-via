...
def _remediation_steps(root: str) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _step(
            "release.atomic_helper_present",
            phase=30,
            purpose="Install the reviewed atomic helper and both local dependencies without activating a release.",
            preconditions=(
            ...
            rollback=(
                f"sudo rm -f {qroot}/scripts/ops/atomic_release_layout.py {qroot}/scripts/ops/atomic_release_integrity.py {qroot}/scripts/ops/atomic_release_units.py",
            ),
            verify=(
