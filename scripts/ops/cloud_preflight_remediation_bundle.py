...
def _remediation_steps(root: str) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _step(
            ...
            rollback=(
                f"sudo rm -f {qroot}/scripts/ops/atomic_release_layout.py {qroot}/scripts/ops/atomic_release_integrity.py {qroot}/scripts/ops/atomic_release_shared.py {qroot}/scripts/ops/atomic_release_units.py {qroot}/scripts/ops/atomic_release_worker_preflight.py",
            ),
            verify=(
