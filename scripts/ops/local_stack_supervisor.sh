...
SCHEDULER_ALLOWLIST="kol_auto_poll,vkpi_ai_today_hot,vkpi_fit_snapshot,vkpi_comment_sentiment_refresh,daily_action_inbox_generate,fulfillment_due_scan,fulfillment_content_scan,vkpi_market_signal_refresh,vkpi_market_intelligence_refresh,vkpi_official_catalog_sync,vkpi_competitor_radar,vkpi_forecast_outcomes_refresh,vkpi_prediction_weekly_rollup"
