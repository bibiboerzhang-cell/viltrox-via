...
_REGISTRY: dict[str, ModelSpec] = {
    GPT: ModelSpec(
        ...
        # 2026-08-22 模型升级刀:默认 OpenAI 档 gpt-5.6-luna(reasoning.effort='none')。
    ...
    GEMINI: ModelSpec(
        ...
        # 2026-08-22 模型升级刀:gemini-3.6-flash 促销价(至 2026-12-31)。
    ...
    CLAUDE: ModelSpec(
        ...
        # 2026-08-22 模型升级刀:claude-sonnet-5($2/$10 正式价,1M 上下文)。
