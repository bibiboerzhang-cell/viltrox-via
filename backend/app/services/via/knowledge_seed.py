...
from app.services.via.knowledge_seed_dynamic_docs import (
    bh_docs as _bh_docs,
    full_product_rule_docs as _full_product_rule_docs,
    market_observation_docs as _market_observation_docs,
    submission_analysis_docs as _submission_analysis_docs,
)
from app.services.via.knowledge_seed_external import (
    _external_knowledge_docs,
