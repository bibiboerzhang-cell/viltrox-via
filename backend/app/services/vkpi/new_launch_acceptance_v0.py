"""P6.74 read-only new launch acceptance estimator v0.

This is a rule estimate, not a trained model. It combines product-fit KOL
candidates, current trend signals, and market risk into an explainable Top N.
"""
