...
_HUMAN_RULES: tuple[tuple[str, tuple[str, ...], str], ...] = (
    ...
    ("budget", ("cap_exceeded",), "这次请求太大,超过了单次上限:请缩小范围后重试"),
    ("budget", ("row_invalid",), "额度设置有误,这项分析已暂停:请联系管理员核对"),
    ("budget", (), "预算已达上限"),
    ...
    ("provider", ("not_configured",), "还没有接上可用的模型服务:请联系管理员完成配置"),
    ("provider", ("force_offline",), "外部模型调用已被临时关闭:请联系管理员"),
    ("provider", ("calls_blocked",), "外部模型调用已被关闭:请联系管理员"),
    ("provider", ("no_provider_candidates",), "暂时没有可用的模型"),
    ("provider", (), "分析服务繁忙"),
