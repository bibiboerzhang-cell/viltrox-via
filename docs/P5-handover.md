...
| commit | 内容 | 性质 |
|---|---|---|
| `6124c74a` | 上线审查 F1(formatMoney null 守卫)+ F2(V6 路径 evidence 三 props)+ F4(回滚序改写三档) | 前端阻断修复,dist=6124c74a |
...
效果:费用/物流 tab 产品成本估算出真数字;新建项目产品 datalist(369 官网 SKU 之外含全部成本目录项)复活。**F3(员工可见性)仍待用户拍板,明早写窗口执行。**
